...
def test_report_pipeline():
    ...
    mock_data = {
        ...
        "context": {"symbol": "BTC/USDT", "sources": ["Binance_Spot", "System_Harness"]},
        "key_findings": ["Market structure is bullish on 4H", "Support holding firm"],
        "evidence_for": ["Golden Cross on move", "Volume increasing"],
        "evidence_against": ["Overbought on 1H", "Macro resistance ahead"],
        "risk_flags": ["High volatility event in 2h", "Low liquidity in order book"],
        "recommendations": ["Long on breakout", "Tight SL at 64,500"],
        "next_actions": ["Monitor 68k breakout", "Review bias in 12h"],
        "metadata": {"generated_at": "2026-04-16T22:45:00", "engine_version": "v0.1-PFIOS"},
    }
