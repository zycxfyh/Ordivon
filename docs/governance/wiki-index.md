...
| [Document Lifecycle](../governance/document-lifecycle.md) | `docs/governance/document-lifecycle.md` | governance_pack | accepted | current_status | L2 | 2026-04-30 |
...
| [Alpaca Paper Trading Constitution](../runtime/alpaca-paper-trading-constitution.md) | `docs/runtime/alpaca-paper-trading-constitution.md` | runtime | current | current_status | L3 | 2026-04-29 |
...
| [Ordivon Stage Summit — Phase 4 Close](../product/ordivon-stage-summit-phase-4.md) | `docs/product/ordivon-stage-summit-phase-4.md` | stage_summit | closed | current_status | L3 | 2026-04-29 |
| [Ordivon Stage Summit — Phase 6 Close](../product/ordivon-stage-summit-phase-6.md) | `docs/product/ordivon-stage-summit-phase-6.md` | stage_summit | closed | current_status | L3 | 2026-04-29 |
| [Paper Dogfood JSONL Ledger](../runtime/paper-trades/paper-dogfood-ledger.jsonl) | `docs/runtime/paper-trades/paper-dogfood-ledger.jsonl` | ledger | closed | supporting_evidence | L3 | 2026-04-29 |
| [Alpaca Paper CandidateRule Handling](../runtime/alpaca-paper-candidate-rule-handling.md) | `docs/runtime/alpaca-paper-candidate-rule-handling.md` | runtime | closed | supporting_evidence | L3 | 2026-04-29 |
